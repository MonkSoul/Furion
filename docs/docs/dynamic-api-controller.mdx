...
import dgqqwcUrl from "../static/img/dgqqwc.png";
...
import namepzUrl from "../static/img/namepz.png";
...
import keepnamepzUrl from "../static/img/keepnamepz.png";

<img src={keepnamepzUrl} />
...
import splitnamepzUrl from "../static/img/splitnamepz.png";

<img src={splitnamepzUrl} />
...
import keepverbpzUrl from "../static/img/keepverbpz.png";

<img src={keepverbpzUrl} />
...
import enablepzUrl from "../static/img/enablepz.png";
...
import modulepzUrl from "../static/img/modulepz.png";
...
import versionpzUrl from "../static/img/versionpz.png";

<img src={versionpzUrl} />
...
import dfzUrl from "../static/img/dfz.gif";
...
import tag1Url from "../static/img/tag1.png";
import tag2Url from "../static/img/tag2.png";
...
### 3.9.11 `AuthPolicies` 配置

`AuthPolicies` 配置主要用于接口授权信息。
