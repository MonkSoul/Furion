...
namespace Fur.Application.Functions
{
    public interface ITestAppService
    {
        ...
        /// <returns></returns>
        Task<PagedList> GetAsync(int pageIndex = 1, int pageSize = 20);
        ...
        /// <returns></returns>
        Task<IEnumerable<TestOutput>> SqlProcedureAsync(string name);

        /// <summary>
        /// 调用数据库标量函数
        /// </summary>
        /// <returns></returns>
        Task<int> SqlScalarFunctionAsync();

        /// <summary>
        /// 调用数据库表值函数
        /// </summary>
        /// <returns></returns>
        Task<IEnumerable<TestOutput>> SqlTableFunctionAsync();
