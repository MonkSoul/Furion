...
namespace Fur.DatabaseVisitor.Tangent
{
    public class TangentAsyncInterceptor : IAsyncInterceptor
    {
        ...
        //        private string CreateSql(MethodInfo methodInfo, object[] arguments, List<SqlParameter> parameters, DbCompileTypeOptions dbFunctionTypeOptions, bool IsPrimitiveArguments, DbCanInvokeAttribute dbCanInvokeAttribute)
        //        {
        //            string sql;
        //            if (IsPrimitiveArguments)
        //            {
        //                var sqlParameters = CreateSqlParameters(methodInfo, arguments);
        //                sql = Helper.CombineExecuteSql(dbFunctionTypeOptions, dbCanInvokeAttribute.Name, sqlParameters);
        //                parameters.AddRange(sqlParameters);
        //            }
        //            else
        //            {
        //                var result = Helper.CombineExecuteSql(dbFunctionTypeOptions, dbCanInvokeAttribute.Name, arguments?.FirstOrDefault());
        //                sql = result.sql;
