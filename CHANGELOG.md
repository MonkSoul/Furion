...
- **文档**
  ...
  - [更新] 事件总线文档、选项文档、即时通讯文档、`.NET5` 升级 `.NET6` 文档、依赖注入文档
- **本期亮点**
...
<img src="https://dotnetchina.gitee.io/furion/img/swg2.png" />
...
<img src="https://dotnetchina.gitee.io/furion/img/swg1.png" />
