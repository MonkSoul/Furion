...
## 9.5.8 仓储工厂 `IRepositoryFactory<TEntity>`

:::important 版本说明

以下内容仅限 `Furion 4.9.1.1 +` 版本使用。
...
这样的功能非常适用于多线程或者 `Blazor` 项目中（[相关文档](https://learn.microsoft.com/zh-cn/aspnet/core/blazor/blazor-ef-core?view=aspnetcore-7.0)），如：
