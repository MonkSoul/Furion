...
| ----------------------------- | ----------------------------------- | -------- | ------------------------------ |
| http://www.chinadot.net/      | http://www.chinadot.net/index.html  | 否       | 同源（协议、域名、端口号相同） |
| http://www.chinadot.net/      | https://www.chinadot.net/index.html | 跨域     | 协议不同（http/https）         |
| http://www.chinadot.net/      | http://www.baidu.com/               | 跨域     | 主域名不同（chinadot/baidu）   |
| http://www.chinadot.net/      | http://blog.chinadot.net/           | 跨域     | 子域名不同（www/blog）         |
| http://www.chinadot.net:8080/ | http://www.chinadot.net:7001/       | 跨域     | 端口号不同（8080/7001）        |
