...
| ------------------------------- | ------------------------------------- | -------- | ------------------------------ |
| http://furion.baiqian.ltd/      | http://furion.baiqian.ltd/index.html  | 否       | 同源（协议、域名、端口号相同） |
| http://furion.baiqian.ltd/      | https://furion.baiqian.ltd/index.html | 跨域     | 协议不同（http/https）         |
| http://furion.baiqian.ltd/      | http://www.baidu.com/                 | 跨域     | 主域名不同（chinadot/baidu）   |
| http://furion.baiqian.ltd/      | http://blog.furion.baiqian.ltd/       | 跨域     | 子域名不同（www/blog）         |
| http://furion.baiqian.ltd:8080/ | http://furion.baiqian.ltd:7001/       | 跨域     | 端口号不同（8080/7001）        |
...
```json showLineNumbers  {4}
{
  "CorsAccessorSettings": {
    "PolicyName": "自定义跨域策略名",
    "WithOrigins": ["http://localhost:4200", "https://furion.baiqian.ltd"]
  }
}
```
