...
### 4.4.1 注册动态 `WebAPI` 服务

在 `Fur` 框架中，动态 `WebAPI` 服务需要在 `Fur.Web.Entry/Startup.cs` 中注册。如：

```cs {4,19-20} title="Fur.Web.Entry/Startup.cs"
...
## 4.10 `DynamicApiControllerSettings` 配置
