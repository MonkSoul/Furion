...
// 示例三  (多个where里是”并且“，Id>10 and Name == "Furion")
var persons = repository.Where(u => u.Id > 10).Where(u => u.Name.Equals("Furion"));

// 示例四 (判断name是否有值，如果name是空的则不会执行u => u.Id > 10 && u.Name.Equals("Furion")，如果name有值就会执行u => u.Id > 10 && u.Name.Equals("Furion"))
...
// 示例六 (在一个where里用逗号分隔是”或者“，Name=="Furion" or Name == "百小僧" or Name == "MonkSoul")
