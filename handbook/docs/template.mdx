...
# Mvc 模板
dotnet new --install Furion.Template.Mvc::4.8.8.26
# WebApi 模板
dotnet new --install Furion.Template.Api::4.8.8.26
# Mvc/WebApi 模板
dotnet new --install Furion.Template.App::4.8.8.26
# RazorPages 模板
dotnet new --install Furion.Template.Razor::4.8.8.26
# RazorPages/WebApi 模板
dotnet new --install Furion.Template.RazorWithWebApi::4.8.8.26
# Blazor 模板
dotnet new --install Furion.Template.Blazor::4.8.8.26
# Blazor/WebApi 模板
dotnet new --install Furion.Template.BlazorWithWebAPI::4.8.8.26
```
...
```bash showLineNumbers
# Mvc 模板
dotnet new --install Furion.SqlSugar.Template.Mvc::4.8.8.26
# WebApi 模板
dotnet new --install Furion.SqlSugar.Template.Api::4.8.8.26
# Mvc/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.App::4.8.8.26
# RazorPages 模板
dotnet new --install Furion.SqlSugar.Template.Razor::4.8.8.26
# RazorPages/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.RazorWithWebApi::4.8.8.26
# Blazor 模板
dotnet new --install Furion.SqlSugar.Template.Blazor::4.8.8.26
# Blazor/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.BlazorWithWebAPI::4.8.8.26
```
