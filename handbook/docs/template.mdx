...
# Mvc 模板
dotnet new --install Furion.Template.Mvc::4.8.8.10
# WebApi 模板
dotnet new --install Furion.Template.Api::4.8.8.10
# Mvc/WebApi 模板
dotnet new --install Furion.Template.App::4.8.8.10
# RazorPages 模板
dotnet new --install Furion.Template.Razor::4.8.8.10
# RazorPages/WebApi 模板
dotnet new --install Furion.Template.RazorWithWebApi::4.8.8.10
# Blazor 模板
dotnet new --install Furion.Template.Blazor::4.8.8.10
# Blazor/WebApi 模板
dotnet new --install Furion.Template.BlazorWithWebAPI::4.8.8.10
```
...
```bash showLineNumbers
# Mvc 模板
dotnet new --install Furion.SqlSugar.Template.Mvc::4.8.8.10
# WebApi 模板
dotnet new --install Furion.SqlSugar.Template.Api::4.8.8.10
# Mvc/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.App::4.8.8.10
# RazorPages 模板
dotnet new --install Furion.SqlSugar.Template.Razor::4.8.8.10
# RazorPages/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.RazorWithWebApi::4.8.8.10
# Blazor 模板
dotnet new --install Furion.SqlSugar.Template.Blazor::4.8.8.10
# Blazor/WebApi 模板
dotnet new --install Furion.SqlSugar.Template.BlazorWithWebAPI::4.8.8.10
```
