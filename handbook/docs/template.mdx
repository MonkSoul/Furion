...
# Mvc 模板
dotnet new install Furion.Template.Mvc::4.9.1.6
# WebApi 模板
dotnet new install Furion.Template.Api::4.9.1.6
# Mvc/WebApi 模板
dotnet new install Furion.Template.App::4.9.1.6
# RazorPages 模板
dotnet new install Furion.Template.Razor::4.9.1.6
# RazorPages/WebApi 模板
dotnet new install Furion.Template.RazorWithWebApi::4.9.1.6
# Blazor 模板
dotnet new install Furion.Template.Blazor::4.9.1.6
# Blazor/WebApi 模板
dotnet new install Furion.Template.BlazorWithWebAPI::4.9.1.6
```
...
```bash showLineNumbers
# Mvc 模板
dotnet new install Furion.SqlSugar.Template.Mvc::4.9.1.6
# WebApi 模板
dotnet new install Furion.SqlSugar.Template.Api::4.9.1.6
# Mvc/WebApi 模板
dotnet new install Furion.SqlSugar.Template.App::4.9.1.6
# RazorPages 模板
dotnet new install Furion.SqlSugar.Template.Razor::4.9.1.6
# RazorPages/WebApi 模板
dotnet new install Furion.SqlSugar.Template.RazorWithWebApi::4.9.1.6
# Blazor 模板
dotnet new install Furion.SqlSugar.Template.Blazor::4.9.1.6
# Blazor/WebApi 模板
dotnet new install Furion.SqlSugar.Template.BlazorWithWebAPI::4.9.1.6
```
