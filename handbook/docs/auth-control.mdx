...
**[查看完整代码 - https://gitee.com/dotnetchina/Furion/tree/net6/clients/axios](https://gitee.com/dotnetchina/Furion/tree/net6/clients/axios)**

```js showLineNumbers {14,19,41}
// token 键定义
...
可以解密之后读取 `过期时间 exp` 来决定什么时候请求需要添加刷新 `Token` 哦。
