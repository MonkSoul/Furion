...
`Fur` 框架中的 `AppDbContext` 数据库上下文哈有 `ISqlDispatchProxy` 都是通过这种方式创建的。
...
namespace Fur.Application
{
    public class LogDispatchProxy : DispatchProxy, IDispatchProxy
    {
        ...
        /// <summary>
        /// 服务提供器，可以用来解析服务，如：ServiceProvider.GetService()
        /// </summary>
        ...
        protected override object Invoke(MethodInfo targetMethod, object[] args)
        {
            ...
            var result = targetMethod.Invoke(targetMethod, args);
