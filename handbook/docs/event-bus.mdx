...
**在 `Furion v2.19+` 版本后，对事件总线进行了重构，以下内容不再适合，后续将重写该文档，查看新的使用说明可查阅 `Issue`：[https://gitee.com/dotnetchina/Furion/issues/I46X02](https://gitee.com/dotnetchina/Furion/issues/I46X02)**
