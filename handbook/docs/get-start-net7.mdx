---
id: get-start-net7
title: 2.4 ASP.NET 7 集成
sidebar_label: 2.4 ASP.NET 7 集成
description: 学习如何在 ASP.NET 7 中集成 Furion
---
...
### 2.4.1.1 创建 `ASP.NET Core Web 应用程序`
