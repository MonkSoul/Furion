...
当然也可以尝试下面的代码解决，固定时间为北京时间。

```cs showLineNumbers {1,3}
services.Configure<RequestLocalizationOptions>(options =>
{
    options.DefaultRequestCulture.Culture.DateTimeFormat = new CultureInfo("zh-CN").DateTimeFormat;
});
```
...
- 相关 `Issue`：[https://gitee.com/dotnetchina/Furion/issues/I6RUOU](https://gitee.com/dotnetchina/Furion/issues/I6RUOU)
- 参考资料：[https://dotnetcoretutorials.com/2017/06/22/request-culture-asp-net-core/](https://dotnetcoretutorials.com/2017/06/22/request-culture-asp-net-core/)
