...
`SqlSugar` 与 EF优势： 性能比EF更快、语法上手更容易

`SqlSuar`  与 Dapper优势：  SqlSugar功能更加丰富，性能丝毫不逊色于Dapper，并且批量操作性能更好
...
var data5 = repository.GetPageList(it => it.Name == "xx", p);
...
###  10.1.5 使用SqlSugarClient操作数据库对象
