...
public class SingleFilePublish : ISingleFilePublish
{
    ...
    public string[] IncludeAssemblyNames()
    {
        ...
        return new[]
        {
            ...
            "Furion.Extras.ObjectMapper.Mapster"    // 解决 Mapster 单文件失效问题
        };
    }
}
```
...
如果发布后出现 `Mapster` 不能映射问题，可将 `Furion.Extras.ObjectMapper.Mapster` 添加到 `IncludeAssemblyNames` 集合中即可。
