...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> `Log.ScopeContext` 和 `"some log".ScopeContext` 拓展 <sup>4.5.3</sup>
...
- **突破性变化**
  ...
  - &nbsp;<Tag>移除</Tag> **主机未启动时构建服务的操作权限，此操作会导致内存激增，受影响方法： `App.GetSerice` 和 `Scoped.Create` ** <sup>4.5.3</sup> [#I5U0A4](https://gitee.com/dotnetchina/Furion/issues/I5U0A4)
