...
- `v4.9.1` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I8GHNK](https://gitee.com/dotnetchina/Furion/issues/I8GHNK) <sup>2023.11.15 ~ <b>2023.11.16</b> 🆕</sup>
...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> `System.Text.Json` 自动将时间戳转换为 `DateTime/DateTimeOffset` 类型 <sup>4.9.1.2</sup> <sup>⏱️2023.11.17</sup>
