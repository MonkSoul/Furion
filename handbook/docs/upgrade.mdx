...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> 定时任务设置触发器 `Result` 后作业执行异常不能重置问题 <sup>4.9.1.7</sup> <sup>⏱️2023.11.24</sup>
...
- **贡献者**
  ...
  - zuohuaijun ([@zuohuaijun](https://gitee.com/zuohuaijun)) [!864](https://gitee.com/dotnetchina/Furion/pulls/864)
