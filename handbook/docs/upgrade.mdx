...
- `v4.8.8` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I6VF8V](https://gitee.com/dotnetchina/Furion/issues/I6VF8V) <sup>2023.04.13 ~ <b>2023.10.11</b></sup>
...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> 定时任务看板中间件 `SSE` 请求不是长连接导致连接频繁初始化销毁 <sup>4.8.8.49</sup> <sup>⏱️2023.10.26</sup> 
