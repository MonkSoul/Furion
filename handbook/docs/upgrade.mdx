...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> **自 `v4.5.2+` 版本升级后出现启动时使用 `App.GetOptons<TOptions>` 异常问题** <sup>4.5.6</sup> [f9a6587](https://gitee.com/dotnetchina/Furion/commit/f9a6587e3f7893db88c905cf77c3c4ebed39b73c)
...
- **文档**
  ...
  - &nbsp;<Tag>更新</Tag> 日志记录文档、动态 WebAPI 文档、选项文档
