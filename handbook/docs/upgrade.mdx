...
- `v4.6.0` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I5TD4X](https://gitee.com/dotnetchina/Furion/issues/I5TD4X) <sup>2022.09.27</sup>

:::

- **新特性**

  - &nbsp;<Tag>新增</Tag> `LoggingMonitor` 支持 `FileResult` 类型监听 <sup>4.6.0</sup>
