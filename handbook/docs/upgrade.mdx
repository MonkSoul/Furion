...
- **新特性**
  ...
  - [新增] **事件总线 `MessageCenter` 静态类，解决 `Fur v1.x` 版本升级问题**
...
- **突破性变化**
  ...
  - [调整] **事件总线 `IEventBusFactory` 事件工厂方法 `AddSubscriber -> Subscribe`，`RemoveSubscriber -> Unsubscribe`**
...
- **文档**
  ...
  - [更新] `AppSettings` 配置文档、事件总线文档、多数据库配置文档、日志文档、定时任务文档
