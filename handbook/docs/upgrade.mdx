...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> `LoggingMonitor` 同时配置了局部和全局日志监听触发两次问题 <sup>4.5.2</sup> [7fb3036](https://gitee.com/dotnetchina/Furion/commit/7fb30368f9640360017fc7f357df13eeb5031c2b)
