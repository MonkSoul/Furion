...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> 监听日志 `LoggingMonitor` 监听 `TraceId`、`ThreadId`、`Accept-Language` <sup>4.8.7.1</sup> <sup>⏱️2023.02.27</sup>
...
- **其他更改**
  ...
  - &nbsp;<Tag>调整</Tag> 监听日志 `LoggingMonitor` 返回值泛型字符串显示格式 <sup>4.8.7.1</sup> <sup>⏱️2023.02.27</sup>
