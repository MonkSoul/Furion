...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> `LoggingMonitor` 输出 `系统信息` 和 `.NET 运行时版本` <sup>4.7.1</sup> [aeda902](https://gitee.com/dotnetchina/Furion/commit/aeda90259ef0684bff6308e2f387d89ac9081d37)
