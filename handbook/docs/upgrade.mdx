...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> 修复 `app.UseInject(action)` 导致死循环 <sup>4.5.7</sup> [!608](https://gitee.com/dotnetchina/Furion/pulls/608)
...
- **文档**
  ...
  - &nbsp;<Tag>更新</Tag> 日志记录文档、动态 WebAPI 文档、选项文档、`HttpContext` 文档、远程请求文件
