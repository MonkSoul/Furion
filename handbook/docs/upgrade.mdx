...
- **突破性变化**
  ...
  - &nbsp;<Tag>新增</Tag> 定时任务作业计划 `OnChanged` 事件处理 <sup>4.8.8.29</sup> <sup>⏱️2023.06.25</sup>
  - &nbsp;<Tag>移除</Tag> **定时任务看板 `SyncRate` 配置，前后端采用最新的 `SSE` 推送技术替代** <sup>4.8.8.29</sup> <sup>⏱️2023.06.25</sup>
