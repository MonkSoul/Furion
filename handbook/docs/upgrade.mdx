...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> `LoggingMonitor` 打印泛型类型如果存在多个泛型参数问题 <sup>4.8.8.8</sup> <sup>⏱️2023.05.03</sup> [8d9cb74](https://gitee.com/dotnetchina/Furion/commit/8d9cb7457c736a91bc428ce61da553df40107960)
