...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> **🎉 [全新的定时任务模块](./job)** <sup>4.8.0</sup> 【[查看源码](https://gitee.com/dotnetchina/Furion/tree/v4/framework/Furion/Schedule)】
  - &nbsp;<Tag>新增</Tag> **🎉 [全新的 `Cron` 表达式模块](./cron)** <sup>4.8.0</sup> 【[查看源码](https://gitee.com/dotnetchina/Furion/tree/v4/framework/Furion/TimeCrontab)】
...
- **文档**
  ...
  - &nbsp;<Tag>新增</Tag> **[新版本定时任务文档](./job)**
  - &nbsp;<Tag>新增</Tag> **[Cron 表达式解析文档](./cron)**
  - &nbsp;<Tag>新增</Tag> [Schedular](./global/schedular) 全局静态类文档
  - &nbsp;<Tag>更新</Tag> `Serve.Run()` 入门文档文档、安全授权文档、前端接口代理文档、事件总线文档、日志文档
