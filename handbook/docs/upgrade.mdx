...
- **突破性变化**
  ...
  - &nbsp;<Tag>调整</Tag> `IJsonSerializerProvider` 序列化接口，添加 `Deserialize` 反序列化方法 <sup>4.8.8.15</sup> <sup>⏱️2023.05.14</sup> [!815](https://gitee.com/dotnetchina/Furion/pulls/815) 感谢 [@YaChengMu](https://gitee.com/YaChengMu)
