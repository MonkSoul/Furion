...
- **新特性**
  ...
  - [新增] `BadPageResult` 错误页面类型 [!494](https://gitee.com/dotnetchina/Furion/pulls/495)
...
- **突破性变化**
  ...
  - [支持] 项目类型为 `<Project Sdk="Microsoft.NET.Sdk">` 的控制台项目 [fb08a65](https://gitee.com/dotnetchina/Furion/commit/fb08a6548d49921aa143d01389a2592b92e94e31)
  - [新增] `Serve.Run()` 极简主机模式，真正实现极速入门。[95cac5b](https://gitee.com/dotnetchina/Furion/commit/95cac5b391b70d73bfc94147ee40eef529b2eec6)
  - [调整] 未启用规范化结果时，`MVC` 验证失败返回 `BadPageResult()` 页面类型 [!494](https://gitee.com/dotnetchina/Furion/pulls/495)
