...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> 定时任务 `Schedular.CompileCSharpClassCode(code)` 支持动态编译作业处理程序代码 <sup>4.8.8.7</sup> <sup>⏱️2023.04.30</sup>
  - &nbsp;<Tag>新增</Tag> `App.CompileCSharpClassCode(code)` 动态编译类定义代码 <sup>4.8.8.7</sup> <sup>⏱️2023.04.30</sup>
