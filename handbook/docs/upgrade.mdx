...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> **`WinForm/WPF` 支持依赖注入的 `Native.CreateInstance<T>()` 静态方法** <sup>4.8.7.23</sup> <sup>⏱️2023.03.27</sup>
  - &nbsp;<Tag>新增</Tag> **`WinForm/WPF` 快速注册静态方法：`Serve.RunNative()`** <sup>4.8.7.23</sup> <sup>⏱️2023.03.27</sup>
