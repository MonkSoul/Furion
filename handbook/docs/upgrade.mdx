...
- `v4.9.1` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I8GHNK](https://gitee.com/dotnetchina/Furion/issues/I8GHNK) <sup>2023.11.15 ~ <b>2023.11.20</b> 🆕</sup>
...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> `[AppDbContext]` 特性支持 `UseSnakeCaseNaming` 属性配置表名使用蛇形命名 <sup>4.9.1.5</sup> <sup>⏱️2023.11.20</sup> [!863](https://gitee.com/dotnetchina/Furion/pulls/863)
...
- **文档**
  ...
  - &nbsp;<Tag>更新</Tag> 仓储文档、`Db` 静态类文档、脚手架文档、`.NET7` 升级 `.NET8` 文档、`JSON` 序列化文档、`Docker` 部署文档
