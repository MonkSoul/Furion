...
- **突破性变化**
  ...
  - [重构] 依赖注入注册底层源码 [#I41PWT](https://gitee.com/dotnetchina/Furion/issues/I41PWT)
...
- **问题修复**
  ...
  - [修复] `tools/ps1` 中文乱码问题 [!360](https://gitee.com/dotnetchina/Furion/pulls/360) [#I41Q1L](https://gitee.com/dotnetchina/Furion/issues/I41Q1L)
