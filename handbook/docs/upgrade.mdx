...
- `v4.9.1` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I8GHNK](https://gitee.com/dotnetchina/Furion/issues/I8GHNK) <sup>2023.11.15 ~ <b>2023.11.15</b> 🆕</sup>
...
- **新特性**
  ...
  - &nbsp;<Tag>新增</Tag> `IRepositoryFactory<TEntity, TDbContextLocator>` 仓储功能，解决在 `Blazor` 中使用 `EFCore` 问题 <sup>4.9.1.1</sup> <sup>⏱️2023.11.16</sup> [文档说明](https://learn.microsoft.com/zh-cn/aspnet/core/blazor/blazor-ef-core?view=aspnetcore-7.0)
