...
- `v4.8.0` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/敬请期待](https://gitee.com/dotnetchina/Furion) <sup>2022.11.21</sup>
...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> `ASP.NET Core` 部署在 `Windows Services` 下文件日志根目录是：`C:\Windows\System32` 问题 <sup>4.8.0</sup> [d0e46b4](https://gitee.com/dotnetchina/Furion/commit/d0e46b4b1d52502b769d8f6998ff2c00fcb1d528)
