...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> `LoggingMonitor` 配置 `WriteFilter` 不起作用问题 <sup>4.8.1.1</sup> [#I62P52](https://gitee.com/dotnetchina/Furion/issues/I62P52) [90bcfda](https://gitee.com/dotnetchina/Furion/commit/90bcfda4e3af24df399cc6bdb5c558c2bbed2536)
