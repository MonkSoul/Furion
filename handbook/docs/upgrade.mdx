...
- **新特性**
  ...
  - [新增] 远程请求对 `Url` 是否编码设置，`[Get(WithEncodeUrl = true)]` 和 `WithEncodeUrl(true)` [#I5GOBC](https://gitee.com/dotnetchina/Furion/issues/I5GOBC)

- **其他更改**

  - [调整] 多语言默认处理逻辑，允许不配置任何语言，过去版本会报错 [#I5GRD9](https://gitee.com/dotnetchina/Furion/issues/I5GRD9)
