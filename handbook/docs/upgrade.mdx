...
- `v4.6.0` 版本细节：[https://gitee.com/dotnetchina/Furion/issues/I5TD4X](https://gitee.com/dotnetchina/Furion/issues/I5TD4X) <sup>2022.10.10</sup>
...
- **突破性变化**
  ...
  - &nbsp;<Tag>移除</Tag> `"some log".SetCategory(name)` 拓展方法 <sup>4.6.0</sup>
...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> 框架内部所有使用 `.CreateLogger` 创建的日志对象无法应用上下文问题 <sup>4.6.0</sup>
