...
- **突破性变化**
  ...
  - &nbsp;<Tag>调整</Tag> **重构日志模块设置上下文功能** <sup>4.6.0</sup> [1c198ee](https://gitee.com/dotnetchina/Furion/commit/1c198ee2701e0ca76bca1057df6fce6789344c35)
...
- **问题修复**
  ...
  - &nbsp;<Tag>修复</Tag> 修复远程请求不能在 `Worker Serivce` 中进行构造函数注入，原因是注册了 `Scope` 范围作用域 <sup>4.6.3</sup>
  - &nbsp;<Tag>修复</Tag> 个别服务器的 `SQL Server` 不支持 `TLS 1.2` 协议问题 <sup>4.6.3</sup>
...
- **文档**
  ...
  - &nbsp;<Tag>更新</Tag> 日志记录文档、事件总线文档、数据库入门文档
