...
`Furion` 也提供了 **[Swagger-Editor.rar](https://gitee.com/dotnetchina/Furion/blob/net6/clients/Swagger-Editor.rar)** 离线包，可直接下载解压并双击 `index.html` 即可。
...
`Furion` 官网也提供了 `Swagger-Editor.rar` 离线包下载：[https://gitee.com/dotnetchina/Furion/blob/net6/clients/Swagger-Editor.rar](https://gitee.com/dotnetchina/Furion/blob/net6/clients/Swagger-Editor.rar)
