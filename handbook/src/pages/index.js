      ...
      <div className="furion-banner-container">
        <div className="furion-banner-item">
          ...
          <div className="furion-get-start-btn">
            <Link className="furion-get-start" to={useBaseUrl("docs/category/getstart")}>
              入门指南
              <span className="furion-version">v4.8.7.20</span>
            </Link>
            <Link
    ...
    <div className="furion-content">
      ...
      <div className="furion-gitee-log">
        ...
        >
          ...
          ></div>
          <div className="furion-log-number">
            <div style={{ color: "#1fd898" }}>7,151,785</div>
    ...
    <div className="furion-whouse">
      ...
      <div className="furion-who-des">
        <div style={{ maxWidth: 350 }}>
          ...
          <p>
            Furion 已在 NuGet
            平台超715万次下载。从小型企业到企业的解决方案及知名企业。他们在简单软件和复杂管理系统的开发方面都信任我们。
          </p>
          <a
